...
#ifndef STATE_CHART_INTERNAL_MODEL_ASSIGN_H_
#define STATE_CHART_INTERNAL_MODEL_ASSIGN_H_
...
class Assign : public ExecutableContent {
 public:
  Assign(const string& location, const string& expr);
...
#endif  // STATE_CHART_INTERNAL_MODEL_ASSIGN_H_
